...
import com.game.andreliu.dungeondivers.MainActivity;
...
public class NewGameActivity extends ActionBarActivity {
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position){
                case 0:
                    return NewGameDifficultyFragment.createInstance(NewGameActivity.this);
                case 1:
                    return NewGameBackgroundFragment.createInstance(NewGameActivity.this);
            }
            return NewGameDifficultyFragment.createInstance(NewGameActivity.this);
        }
